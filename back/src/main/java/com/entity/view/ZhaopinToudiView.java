...
public class ZhaopinToudiView extends ZhaopinToudiEntity implements Serializable {
	...
	* 结果的值
	*/
	@ColumnInfo(comment="结果的字典表值",type="varchar(200)")
	private String zhaopinToudiJieguoValue;
	...
	* 获取： 结果的值
	*/
	public String getZhaopinToudiJieguoValue() {
		return zhaopinToudiJieguoValue;
	}
	/**
	* 设置： 结果的值
	*/
	public void setZhaopinToudiJieguoValue(String zhaopinToudiJieguoValue) {
		this.zhaopinToudiJieguoValue = zhaopinToudiJieguoValue;
	}
	...
	public String toString() {
		return "ZhaopinToudiView{" +
			...
			", zhaopinToudiJieguoValue=" + zhaopinToudiJieguoValue +
