                ...
                if(!".xls".equals(suffix)){
                    ...
                    if(!file.exists()){
                        ...
                        for(List<String> data:dataList){
                            ...
                            yonghuEntity.setYonghuPhone(data.get(2));                    //用户手机号 要改的
                            yonghuEntity.setYonghuIdNumber(data.get(3));                    //用户身份证号 要改的
                            yonghuEntity.setYonghuEmail(data.get(4));                    //邮箱 要改的
                            yonghuEntity.setSexTypes(Integer.valueOf(data.get(5)));   //性别 要改的
                            yonghuEntity.setYonghuZhuangtaiTypes(Integer.valueOf(data.get(6)));   //用户状态 要改的
